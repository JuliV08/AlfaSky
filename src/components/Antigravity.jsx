...
const AntigravityInner = ({
  ...
  // Global mouse tracking — fires even when hovering cards layered on top of canvas
  ...
  useFrame(state => {
    ...
    let destX = (globalMouse.current.x * v.width) / 2;
    let destY = (globalMouse.current.y * v.height) / 2;
